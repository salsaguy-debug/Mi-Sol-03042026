...
const totalPool = 45; // Increased to ensure we reach image 40 if needed
const pairsCount = 8; 
...
function initGame() {
    ...
    for (let i = 1; i <= totalPool; i++) {
        // Skip specific files not used for cards (3 is back, 30 is logo, 40 is bg)
...
// Logic for flipCard, checkMatch, handleWin, and Audio remains the same
function flipCard() {
